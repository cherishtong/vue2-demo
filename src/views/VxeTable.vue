    ...
    <div>
        <vxe-toolbar>
            <template #buttons>
                ...
                <vxe-button @click="refreshTable">刷新数据</vxe-button>
            </template>
        </vxe-toolbar>

        <vxe-table resizable border="inner" ref="xTable"
           :row-config="{ keyField: 'id', isHover: true }"
            :tree-config="{ transform: false, rowField: 'id', parentField: 'parentId',reserve:true }" :data="tableData"
...
export default {
    data() {
        return {
            tableData:[
                {id:'01',name:'zhaotong',children:[
                    {id:'001',name:'zhaotong1'},
                    {id:'002',name:'zhaotong2'},
                    {id:'003',name:'zhaotong3'}
                ]},
                {id:'02',name:'zt',children:[
                    {id:'021',name:'zt1'},
                    {id:'022',name:'zt2'},
                    {id:'023',name:'zt3'}
                ]}
